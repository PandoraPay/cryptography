...
const {SimpleTxSchemaBuilt} = require('./schema/simple-tx-schema-build')

module.exports = class SimpleTxModel extends BaseTxModel {

    constructor(scope, schema= SimpleTxSchemaBuilt, data, type, creationOptions) {
